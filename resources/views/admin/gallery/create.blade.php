...
<div class="max-w-xl">
    <form action="{{ route('admin.gallery.store') }}" method="post" enctype="multipart/form-data" class="space-y-4">
        ...
        <div>
            ...
            <input type="text" name="title" id="title" value="{{ old('title') }}" placeholder="Légende ou description (optionnel)"
        ...
        <div>
            ...
            <input type="file" name="image" id="image" accept="image/*" required
                   class="w-full rounded-lg border border-gray-300 px-4 py-2 focus:ring-2 focus:ring-[#9B2363]/30 focus:border-[#9B2363]">
            <p class="text-xs text-gray-500 mt-1">JPG, PNG. Max 10 Mo.</p>
