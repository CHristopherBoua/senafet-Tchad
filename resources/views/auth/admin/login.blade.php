...
<div class="min-h-[60vh] flex items-center justify-center px-4 py-12">
    <div class="w-full max-w-md">
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
            <h1 class="text-2xl font-bold text-[#000] text-center mb-2">{{ __('admin.login_title') }}</h1>
            <p class="text-sm text-[#333] text-center mb-6">Administration du site (popup, validations, partenaires)</p>
            ...
            <p class="mt-6 text-center">
                <a href="{{ route('partenaire.login') }}" class="text-sm text-[#C41E3A] hover:underline">Vous êtes partenaire ? Connectez-vous ici</a>
            </p>
        </div>
    </div>
</div>
